...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    guestServiceRequests: "Guest Service Requests",
    guestServiceRequestsSub: "Real-time housekeeping and concierge service requests"
  },
  de: {
    dashboard: 'Dashboard',
    guests: 'Gäste',
    ...
    guestServiceRequests: "Gästeservice-Anfragen",
    guestServiceRequestsSub: "Echtzeit-Anfragen für Reinigung und Concierge-Service"
  },
  it: {
    ...
    guestServiceRequests: "Richieste Servizio Ospiti",
    guestServiceRequestsSub: "Richieste in tempo reale per pulizie e concierge"
  },
  nl: {
    ...
    guestServiceRequests: "Gastservice Verzoeken",
    guestServiceRequestsSub: "Real-time huishoudings- en conciërgedienstverzoeken"
  },
  fr: {
    ...
    guestServiceRequests: "Demandes de Service Clients",
    guestServiceRequestsSub: "Demandes de ménage et de conciergerie en temps réel"
  },
  es: {
    ...
    guestServiceRequests: "Solicitudes de Servicio al Huésped",
    guestServiceRequestsSub: "Solicitudes de limpieza y conserjería en tiempo real"
  },
  pl: {
    ...
    guestServiceRequests: "Zgłoszenia Usług Gości",
    guestServiceRequestsSub: "Zgłoszenia sprzątania i portiera w czasie rzeczywistym"
  },
  ru: {
    ...
    guestServiceRequests: "Запросы Обслуживания Гостей",
    guestServiceRequestsSub: "Запросы на уборку и услуги консьержа в реальном времени"
  },
  ar: {
    ...
    guestServiceRequests: "طلبات خدمة الضيوف",
    guestServiceRequestsSub: "طلبات خدمة التنظيف والكونسيرج في الوقت الفعلي"
  },
  zh: {
    ...
    guestServiceRequests: "客房服务请求",
    guestServiceRequestsSub: "实时客房清洁和礼宾服务请求"
  },
  sv: {
    ...
    guestServiceRequests: "Gästserviceförfrågningar",
    guestServiceRequestsSub: "Städ- och conciergeförfrågningar i realtid"
  },
  ja: {
    ...
    guestServiceRequests: "ゲストサービスリクエスト",
    guestServiceRequestsSub: "リアルタイムのハウスキーピングおよびコンシェルジュリクエスト"
  },
  ko: {
    ...
    guestServiceRequests: "고객 서비스 요청",
    guestServiceRequestsSub: "실시간 하우스키핑 및 컨시어지 서비스 요청"
  }
};
