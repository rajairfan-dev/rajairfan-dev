...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    guestRecordsSub: "Manage current checked-in guests and access room QR codes"
  },
  de: {
    dashboard: 'Dashboard',
    guests: 'Gäste',
    ...
    guestRecords: "Gästedaten",
    guestRecordsSub: "Verwalten Sie eingecheckte Gäste und greifen Sie auf Zimmer-QR-Codes zu"
  },
  it: {
    ...
    guestRecords: "Registro Ospiti",
    guestRecordsSub: "Gestisci gli ospiti registrati e accedi ai codici QR delle camere"
  },
  nl: {
    ...
    guestRecords: "Gastenregister",
    guestRecordsSub: "Beheer ingecheckte gasten en bekijk kamer QR-codes"
  },
  fr: {
    ...
    guestRecords: "Registre des Clients",
    guestRecordsSub: "Gérez les clients enregistrés et accédez aux QR codes des chambres"
  },
  es: {
    ...
    guestRecords: "Registro de Huéspedes",
    guestRecordsSub: "Gestione los huéspedes hospedados y acceda a los códigos QR"
  },
  pl: {
    ...
    guestRecords: "Rejestr Gości",
    guestRecordsSub: "Zarządzaj zameldowanymi gośćmi i uzyskaj kody QR pokoi"
  },
  ru: {
    ...
    guestRecords: "Записи о Гостях",
    guestRecordsSub: "Управление зарегистрированными гостями и QR-кодами номеров"
  },
  ar: {
    ...
    guestRecords: "سجلات الضيوف",
    guestRecordsSub: "إدارة الضيوف المسجلين حاليًا والوصول إلى رموز QR للغرف"
  },
  zh: {
    ...
    guestRecords: "客人记录",
    guestRecordsSub: "管理当前入住客人并获取客房二维码"
  },
  sv: {
    ...
    guestRecords: "Gästregister",
    guestRecordsSub: "Hantera incheckade gäster och få tillgång till rummets QR-koder"
  },
  ja: {
    ...
    guestRecords: "ゲスト記録",
    guestRecordsSub: "チェックイン中のゲストの管理と客室QRコードへのアクセス"
  },
  ko: {
    ...
    guestRecords: "고객 기록",
    guestRecordsSub: "현재 체크인된 고객 관리 및 객실 QR 코드 접근"
  }
};
